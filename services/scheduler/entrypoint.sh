...
printenv | grep -E '^(ODDS_API_KEY|ANTHROPIC_API_KEY|SPORTS|DATA_DIR|TZ|TELEGRAM_BOT_TOKEN|TELEGRAM_CHAT_ID|DASHBOARD_URL|DISCORD_WEBHOOK_URL|PIPELINE_MAX_RETRIES|PIPELINE_RETRY_DELAY)=' > /app/.env.cron
